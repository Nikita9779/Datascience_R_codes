Amtrak<-read.csv('C:/Users/Admin/Downloads/Amtrak.csv') # read the Amtrack data
...
rmse_Add_sea_Linear
From Srinivas ExcelR to Everyone:  03:20 PM
...
rmse_multi_add_sea
From Srinivas ExcelR to Everyone:  03:21 PM
