#Neural Network Algorithm For Start ups
...
startup <- read.csv("E:/Data science Excelr/Assigments/Supervised Machine Learning/Neural Networks/50_startups/50_Startups.csv")
attach(startup)
summary(startup)
sum(is.na(startup))
dim(startup)
...
#Plots
plot(R.D.Spend,Administration, type = "")
...
plot(n1) #Here the error rate is 0.054697
...
#Here we got the Accuracy of the Model as 96.45%
